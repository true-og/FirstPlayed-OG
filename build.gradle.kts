...
/* ----------------------------- Metadata ------------------------------ */
group = "net.trueog.firstplayed-og" // Declare bundle identifier.
...
dependencies {
    ...
    compileOnly("io.github.miniplaceholders:miniplaceholders-api:2.2.3") // Import the MiniPlaceholders API.
...
/* ----------------------------- Shadow -------------------------------- */
tasks.shadowJar {
    relocate("io.lettuce", "net.trueog.shadow.io.lettuce")
